    ...
    public class RemoteControlPageViewModel : Common.ViewModels.ViewModelBase
    {
        ...
        private async Task Refresh()
        {
            ...
            foreach (var combinedControl in combinedControls)
            {
                ...
                var room = new CombinedRoom(combinedControl, hueDevice as Models.Hue.Group, remoDevice as Device, SettingsHelper.Settings.HideIndivisualHueControls.GetValue<bool>());
